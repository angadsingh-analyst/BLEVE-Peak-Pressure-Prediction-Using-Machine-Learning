...
The project demonstrates an end-to-end predictive analytics workflow, including data cleaning, leakage-safe preprocessing, physics-informed feature engineering, model comparison, ensemble modelling, and explainable AI interpretation.
...
- Kaggle public leaderboard MAPE: **0.161348**
- Kaggle private leaderboard MAPE: **0.155453**
